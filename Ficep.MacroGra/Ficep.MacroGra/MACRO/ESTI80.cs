...
{
    public class ESTI80 : EyeMacro
    {

        public ESTI80(IWorkPiece wp, ICopeParams param, string macroClassName, string macroName, EyeParam eyeParam, uint lineNumber = 0)
        ...
        public override bool CreateMacro()
        {
            ...
            macroPoint.Add(new ProgramPoint(0, width - (TB + ParB), 0, 0));
            ...
            macroPoint.Add(new ProgramPoint(ParI - ParJ, width, 0, 0));
            ...
            ProgramPoint startChamfer = new ProgramPoint(ParA - ParC, 0, 0, 0);
            ProgramPoint endChamfer = new ProgramPoint(ParA - ParC, topY, 0, 0);
            ...
            else
            {
                ...
                startChamfer = new ProgramPoint(ParA - ParC, 0, 0, 0);
                endChamfer = new ProgramPoint(ParA - ParC, offsetY - internalChamferDistanceFromWeb, 0, 0);
                ...
                startChamfer = new ProgramPoint(ParA - ParC, offsetY + internalChamferDistanceFromWeb, 0, 0);
                endChamfer = new ProgramPoint(ParA - ParC, topY, 0, 0);
            ...
            startChamfer = new ProgramPoint(ParI - ParJ, 0, 0, 0);
            endChamfer = new ProgramPoint(ParI - ParJ, topY, 0, 0);
            ...
            else
            {
                ...
                startChamfer = new ProgramPoint(ParI - ParJ, 0, 0, 0);
                endChamfer = new ProgramPoint(ParI - ParJ, offsetY - internalChamferDistanceFromWeb, 0, 0);
                ...
                startChamfer = new ProgramPoint(ParI - ParJ, offsetY + internalChamferDistanceFromWeb, 0, 0);
                endChamfer = new ProgramPoint(ParI - ParJ, topY, 0, 0);
