...
{
    public class ESTI160 : EyeMacro
    {
        public ESTI160(IWorkPiece wp, ICopeParams param, string macroClassName, string macroName, EyeParam eyeParam, uint lineNumber = 0)
        ...
        public override bool CreateMacro()
        {
            ...
            double root = 0;
            //  FF
            double A = ParB - ParS, B = ParC - ParR - ParD, C = 2 * ParR - ParB - ParS;
            ...
            double radBeta = !MirrorInizialeFinale ? ParBETA.ToRad() : -ParBETA.ToRad(), tanBeta = Math.Tan(radBeta);
            ...
            macroPoint.Add(new ProgramPoint(ParI - ParJ + ParS * Math.Tan(ParO.ToRad()), width - TB - ParS, 0, 0));// inventato
            ...
            ProgramPoint startChamfer = new ProgramPoint(ParA - ParC + offsetY * tanBeta, 0, 0, 0);
            ProgramPoint endChamfer = new ProgramPoint(ParA - ParC - offsetY * tanBeta, topY, 0, 0);
