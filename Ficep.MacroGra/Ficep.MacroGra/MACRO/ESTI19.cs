...
{
    public class ESTI19 : EyeMacro
    {
        public ESTI19(IWorkPiece wp, ICopeParams param, string macroClassName, string macroName, EyeParam eyeParam, uint lineNumber = 0)
        ...
        public override bool CreateMacro()
        {
            ...
            macroPoint.Add(new ProgramPoint(0, offsetY - ParC / 2, 0, 0));
